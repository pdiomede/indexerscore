    ...
    <body>
        ...
        <div style="text-align: center;">       
            <h1 style="margin-bottom: 4px;">
                ...
                <a href="whats-new.html" style="text-decoration: none;">
                    <span style="background: linear-gradient(135deg, #ff4444 0%, #cc0000 100%); color: white; padding: 4px 12px; border-radius: 20px; font-size: 0.35em; font-weight: bold; margin-left: 10px; display: inline-block; box-shadow: 0 2px 8px rgba(255, 68, 68, 0.4); vertical-align: middle; animation: pulse 2s infinite; cursor: pointer;">✨ NEW</span>
                </a>
            </h1>
