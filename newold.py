...
def generate_indexers_to_html(indexers, filename="index.html"):
    ...
    <head>
        ...
        <style>
            ...
            /* Highlight Delegator style block */
            .highlight-delegator {{
    ...
    <body>
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <h1 style="margin: 0;">Indexer Score - Dashboard</h1>
        ...
        <p style="margin-top: 4px; margin-bottom: 0;">
            <span style="font-size: 0.8em;">Generated on: {timestamp} - (updated every 6 hours) - v{DASHBOARD_VERSION}</span>
        </p>

        <p style="margin-top: 10px;">
            💬 <a target="_blank" href="https://forum.thegraph.com/t/introducing-the-indexer-score/6501">Join the Forum Discussion</a>
            | 📚 <a href="docs.html" style="color: #cccccc;" target="_blank">How the Dashboard Works</a>
        ...
        <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap; margin-bottom: 10px;">
            ...
            <div class="performance-filter" style="display: flex; align-items: center; gap: 8px; font-size: 0.8em;">
                ...
                <a href="#" onclick="filterByFlag('Excellent')">🟢 Excellent ({EXCELLENT_INDEXERS_COUNT})</a>
                | <a href="#" onclick="filterByFlag('Fair')">🟡 Fair ({FAIR_INDEXERS_COUNT})</a>
                | <a href="#" onclick="filterByFlag('Poor')">🔴 Poor ({POOR_INDEXERS_COUNT})</a>
        ...
        <table>
            <tr>
                <th class="tooltip-header">ID<span class="tooltip-text">ETH address or ENS of the Indexer</span></th>
                <th class="tooltip-header">Allocated Stake<span class="tooltip-text">GRT currently allocated by the Indexer</span></th>
                <th class="tooltip-header"># Allocations<span class="tooltip-text">Number of active allocations the Indexer has open</span></th>
                <th class="tooltip-header highlight-delegator">Delegator Reward %<span class="tooltip-text">Percentage of total rewards given to Delegators</span></th>
                <th class="tooltip-header">Delegator Rewards<span class="tooltip-text">Delegators portion of indexing rewards</span></th>
                <th class="tooltip-header">Indexing Rewards<span class="tooltip-text">Indexer portion of indexing rewards</span></th>
                <th class="tooltip-header">Total Rewards<span class="tooltip-text">Total rewards earned (Indexer + delegators)</span></th>
                <th class="tooltip-header">Underserving<span class="tooltip-text">Yes if Indexer is serving fewer than 10 subgraphs</span></th>
                <th class="tooltip-header">Indexer Score<span class="tooltip-text">Final Indexer Score (1 = best, 10 = worst)</span></th>
                <th class="tooltip-header">Performance<span class="tooltip-text">Performance flag based on score</span></th>
            </tr>
    """
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                document.querySelectorAll('th').forEach((header, columnIndex) => {
                    header.addEventListener('click', () => {
                        ...
                        const numericColumns = [1, 2, 3, 4, 5, 7];
